...
#SBATCH --mem=100G                          # Adjust memory as necessary
...
#     --genomeDir /net/nfs-irwrsrchnas01/labs/yunroseli_grp/Bladder_Cancer/Utah_Samples_Biospyder/Batch_1/genome/hg38_index \

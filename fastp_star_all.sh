...
#SBATCH --mem=120G              # Request 200 GB of memory
#SBATCH --time=24:00:00         # Set an appropriate time limit

# Define file locations
fastqz_list="/labs/yunroseli_grp/Jon/32_samples_10182024/code/mappings/fastq_addresses.txt"
fastp_output="/labs/yunroseli_grp/Jon/32_samples_10182024/data/fast_star_all/fastp"

# STAR locations
# star_output="/labs/yunroseli_grp/Jon/32_samples_10182024/data/fast_star_all/STAR"
star_temp_dir="/labs/yunroseli_grp/Jon/32_samples_10182024/data/fast_star_all/STAR/tmp_files"
output_dir="/labs/yunroseli_grp/Jon/32_samples_10182024/data/fast_star_all/STAR/alignment"
...
while IFS= read -r line; do
    ...
    if [[ "$line" == *"_R1_"* ]]; then
        ...
        if [[ -f "$output_r1" && -f "$output_r2" ]]; then
            ...
            echo " "
            echo "-------------------------"
            echo "Completed aligning $star_prefix"
            echo "-------------------------"
            echo " "
            echo " "
